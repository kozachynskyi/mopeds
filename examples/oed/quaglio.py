...
def espie1989():
    ...
    if mode == "constant":
        ...
        oed = mopeds.OptimalExperimentalDesign(m_monod, [varlist_oed], time_grid, oed_settings)
...
def magnusson2015():
    varlist, m_monod, exp_data = mopeds.examples.yeast_growth("monod", piecewise=True, ode=True)
...
def deluca2016(mode="A", plot=False, normalized=False):
    varlist, m_monod, exp_data = mopeds.examples.yeast_growth("monod", piecewise=True, normalize=normalized)
