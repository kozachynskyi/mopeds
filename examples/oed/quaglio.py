...
class CriteriaD_espie1989(mopeds.OED_objective):
    def eval(self, args):
        jac = args[0]
...
class CriteriaD_asprey2002(mopeds.OED_objective):
    def eval(self, args):
        jac = args[0]
        jac_scaled = args[0]  # * self._parameter_scaling
        obj = np.linalg.det(jac_scaled.T @ jac_scaled)
...
class CriteriaD_quaglio2018(mopeds.OED_objective):
    def eval(self, args):
        jac = args[0]
        jac_scaled = args[0]  # * self._parameter_scaling
        obj = np.linalg.det(jac_scaled.T @ jac_scaled)
...
class OED_magnusson2015(mopeds.OptimalExperimentalDesign):
...
def espie1989():
    ...
    oed_settings = mopeds.OEDsettings(num_control_switches=1)
    ...
    if mode == "constant":
        ...
        solution = {
            "u2_t0": 34.99988643472994,
            "u2_t1": 34.99968940498816,
            "u2_t2": 34.99961631831301,
            "u2_t3": 34.999624642771735,
            "u2_t4": 34.99966619272635,
            "u2_t5": 34.99971097586224,
            "u2_t6": 34.999745491330195,
            "u2_t7": 34.999766106679175,
            "u2_t8": 34.99977354109989,
            "u2_t9": 34.999769528072406,
            "u2_t10": 34.99975612983923,
            "u2_t11": 34.99973541412478,
            "u2_t12": 34.99970942891819,
            "u2_t13": 34.999680672585505,
            "u2_t14": 34.999651267461395,
            "u2_t15": 34.99962308695431,
            "u2_t16": 34.999597750484185,
            "u2_t17": 34.99957655155194,
            "u2_t18": 34.99956014858205,
            "u2_t19": 34.999548970866044,
            "u2_t20": 34.99954279351537,
            "u2_t21": 34.99954158963804,
            "u2_t22": 34.99954483384351,
            "u2_t23": 34.999552030280235,
            "u2_t24": 34.99956262051535,
            "u2_t25": 34.999575997238665,
            "u2_t26": 34.999591647137834,
            "u2_t27": 34.99960910583337,
            "u2_t28": 34.99962790252663,
            "u2_t29": 34.99964771056676,
            "u2_t30": 34.999668192143595,
            "u2_t31": 34.99968910894469,
            "u2_t32": 34.999710214808054,
            "u2_t33": 34.99973134657434,
            "u2_t34": 34.99975232668174,
            "u2_t35": 34.99977302209309,
            "u2_t36": 34.99979328450823,
            "u2_t37": 34.99981298221178,
            "u2_t38": 34.99983195553349,
            "u2_t39": 34.99985005580783,
            "u2_t40": 34.99986712832524,
            "u2_t41": 34.9998830381301,
            "u2_t42": 34.999897688233375,
            "u2_t43": 34.99991102228453,
            "u2_t44": 34.99992301328389,
            "u2_t45": 34.99993368050121,
            "u2_t46": 34.99994324337886,
            "u2_t47": 34.99995203851732,
            "u2_t48": 34.999960365794266,
            "u2_t49": 34.999968177119584,
            "u2_t50": 34.999974883294534,
            "u2_t51": 34.99997839284283,
            "u2_t52": 34.99997554112406,
            "u2_t53": 34.99994920573331,
            "u2_t54": 34.99993792303316,
            "u2_t55": 34.99993553743843,
            "u2_t56": 34.999933945833625,
            "u2_t57": 34.999933661929134,
            "u2_t58": 34.99993465557629,
            "u2_t59": 34.99993584956759,
            "u2_t60": 34.999936813379044,
            "u2_t61": 34.99993750563603,
            "u2_t62": 34.99993809019119,
            "u2_t63": 34.99993878387512,
            "u2_t64": 34.999939668023636,
            "u2_t65": 34.99994079802956,
            "u2_t66": 34.99994224596091,
            "u2_t67": 34.99994397555426,
            "u2_t68": 34.99994588065947,
            "u2_t69": 34.999947925768446,
            "u2_t70": 34.999950043538604,
            "u2_t71": 34.99995211103686,
            "u2_t72": 34.999954073006194,
            "u2_t73": 34.999955835576046,
            "u2_t74": 34.999957300853815,
            "u2_t75": 34.99995839376943,
            "u2_t76": 34.99995902174444,
            "u2_t77": 34.99995909782687,
            "u2_t78": 34.99995866248742,
            "u2_t79": 34.99995814183527,
            "u2_t80": 34.999956747992385,
            "u2_t81": 34.999928834963,
            "u2_t82": 34.99986840445507,
            "u2_t83": 34.40587381794541,
            "u2_t84": 5.000031067126143,
            "u2_t85": 5.000021163004472,
            "u2_t86": 5.000017264379194,
            "u2_t87": 5.000013019313238,
            "u2_t88": 5.000017953746731,
            "u2_t89": 34.99996246439409,
            "u2_t90": 34.99996581467536,
            "u2_t91": 34.99996727250451,
            "u2_t92": 34.9999621589868,
            "u2_t93": 34.99996252301505,
            "u2_t94": 34.99994455108265,
            "u2_t95": 34.99983025127333,
        }
        varlist_oed = unfix_parameters(varlist)
        varlist_oed["u2"].fixed = False
        oed = mopeds.OptimalExperimentalDesign(
            m_monod, [varlist_oed], time_grid, oed_settings
        )
...
def asprey2002(plot=False):
    ...
    if mode == "initial":
        ...
        varlist["u2"].value = 35
        varlist["u2"].expand_horizon([20, 25.2], [22.8, 15.0])
...
def hoang2013():
    varlist, m_monod, exp_data = mopeds.examples.yeast_growth(
        "monod", piecewise=True, u1_piecewise_linear=True
    )
    ...
    #     "theta4": 0.5,
    # }
    par_initial = {"theta1": 0.5, "theta2": 0.06, "theta3": 0.5, "theta4": 0.25}
    ...
    if mode == "initial":
        ...
        varlist["u1"].expand_horizon(
            [1, 2, 3, 6, 11],
            [
                0.0623683249324275,
                -0.0430126378844328,
                0.000762496762496763,
                0.000459587089724076,
                -0.0167749287749288,
            ],
        )
        ...
        result_pe = {"theta1": 0.5, "theta2": 0.06, "theta3": 0.5, "theta4": 0.25}
        ...
        pe = mopeds.ParameterEstimation(m_monod, [varlist])
...
def deluca2016(mode="A", plot=False, normalized=False):
    varlist, m_monod, exp_data = mopeds.examples.yeast_growth(
        "monod", piecewise=True, normalize=normalized
    )
