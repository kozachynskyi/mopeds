...
if __name__ == "__main__":
    ...
    exp_data, true_params, _ = mopeds.tools.generate_artificial_data_nle(MODEL , VAR_LIST, cl, perturbate=False)
    ...
    for par in list_params:
        for par_name, par_value in par.items():
            ...
            prediction, _, _ = mopeds.tools.generate_artificial_data_from_grid_nle(MODEL, VAR_LIST, {"x": [0., ub, grid_num]}, perturbate=False)
            y_data = []
