...
if __name__ == "__main__":
    ...
    data1["e0_T_in"] = mopeds.VariableControlPiecewiseConstant(
    ...
    data2["e0_T_in"] = mopeds.VariableControlPiecewiseConstant(
        "e0_T_in", 373.0, 353.0, 393.0
    )
    ...
    mpc = mopeds.ModelPredictiveControl(
    ...
    mpc = mopeds.ModelPredictiveControl(m, [data2], number_of_time_horizonts=4)
    print(f"Optimizer calculates control variables at time:\n {mpc.time_grid_controls}")
