...
if __name__ == "__main__":
    ...
    data1 = mopeds.tools.generate_varlist_with_data(variable_list, m, time_grid1, True, perturbate=True)
    data2 = mopeds.tools.generate_varlist_with_data(variable_list, m, time_grid2, True, perturbate=True)
