...
def initialize_problem():
    ...
    variable_list.add_variable(par_est.VariableControl("e0_x_i1_j1", 0.2))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_x_i2_j1", 0.6))
    variable_list.add_variable(par_est.VariableParameter("e0_greek_nu_r3_i2", 0.0))
    variable_list.add_variable(par_est.VariableControl("e0_x_i3_j1", 0.0))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_x_i4_j1", 0.0))
    variable_list.add_variable(par_est.VariableControl("e0_x_i5_j1", 0.2))
    variable_list.add_variable(par_est.VariableControl("e0_x_i6_j1", 1.0E-16))
    variable_list.add_variable(par_est.VariableParameter("e0_A_par5_i1", 31.5))
    variable_list.add_variable(par_est.VariableControl("e0_T_j2", 500.0))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_p_j2", 50.0))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_F_j1", 1.0))
