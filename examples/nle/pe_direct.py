...
if __name__ == "__main__":
    ...
    exp_data, true_parameters, _ = mopeds.tools.generate_artificial_data_from_grid_nle(
        model,
        varlist_original,
        control_bounds=controls,
        measurement_names=["e0_T", "e0_y_c1"],
        perturbate=False,
    )
    ...
    if True:
        ...
        parameters_guess = {
            "e0_greek_lambdaA_c1_j2": 0.02,
            "e0_greek_lambdaA_c2_j1": -0.5,
        }
        for vl in exp_data:
