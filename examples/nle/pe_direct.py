...
if __name__ == "__main__":
    ...
    exp_data, true_parameters = mopeds.tools.generate_varlist_with_data_NLE(model, varlist_original, control_bounds=controls, measurement_names=["e0_T", "e0_y_c1"], perturbate=False)
