...
def initialize_problem():
    ...
    variable_list.add_variable(par_est.VariableControl("e0_HU_i12", 2.24))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_HU_i14", 9.0))
    ...
    variable_list.add_variable(par_est.VariableControl("e0_HU_i10", 0.0156))
    variable_list.add_variable(par_est.VariableConstant("e0_M_i10", 310.19))
    variable_list.add_variable(par_est.VariableControl("e0_HU_i11", 0.15875))
